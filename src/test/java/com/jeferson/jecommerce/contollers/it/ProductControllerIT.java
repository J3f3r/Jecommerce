...
public class ProductControllerIT {
	...
	void setUp() throws Exception {
		...
		product = new Product(null, "Console PlayStation 5",
				"Lorem ipsum, dolor sit amet consectetur adipisicing elit. ", 3999.90,
	...
	public void updateShouldReturnProductDTOWhenIdExistsAndAdminLogged() throws Exception {
		...
		ResultActions result = mockMvc
				.perform(put("/products/{id}", existingProductId).header("Authorization", "Bearer " + adminToken)
						.content(jsonBody).contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON));
	...
	@Test
	public void updateShouldReturnUnprocessableEntityWhenAdminLoggedAndPriceNegative() throws Exception {
	...
	@Test
	public void updateShouldReturnUnprocessableEntityWhenAdminLoggedAndPriceZero() throws Exception {
	...
	@Test
	public void updateShouldReturnUnprocessableEntityWhenAdminLoggedAndProductHasNotCategory() throws Exception {
	...
	@Test
	public void updateShoulReturnForbiddenWhenIdExistsAndClientLogged() throws Exception{
	...
	@Test
	public void deleteShouldReturnForbiddenWhenIsExistsAndClientLogged() throws Exception {
	...
	@Test
	public void deleteReturnUnauthorizedWhenIdExistsAndInvalidToken() throws Exception {
